...
public class BroadbandUI implements Serializable {
	...
	public String toString() {
		return "BroadbandUI [id=" + id + ", projectId=" + projectId + ", providerId=" + providerId + ", siteId="
				...
				+ ", description=" + description + ", citiesMapping=" + citiesMapping + "]";
	}
